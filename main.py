...
class MyDiscordWebSocket(discord.gateway.DiscordWebSocket):
    async def send_as_json(self, data):
        if data.get('op') == self.IDENTIFY:
            if 'd' in data and 'properties' in data['d']:
...
discord.gateway.DiscordWebSocket.from_client = MyDiscordWebSocket.from_client
