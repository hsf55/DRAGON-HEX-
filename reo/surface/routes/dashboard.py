...
def _render_login(notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title="DRAGON HEX Login", body=body, session=None, notice=notice)
...
def _render_guild_picker(session: dict[str, Any], guilds: list[dict[str, Any]], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title="DRAGON HEX Guilds", body=body, session=session, guilds=guilds, notice=notice)
...
def _render_overview(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], bot_guild, state: dict[str, Any], notice: str | None = None) -> str:
    ...
    return _render_layout(
        title=f"DRAGON HEX Overview - {current_guild['name']}",
        body=body,
        session=session,
        guilds=guilds,
...
def _render_security(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Security - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="security", notice=notice)
...
def _render_moderation(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Moderation - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="moderation", notice=notice)
...
def _render_music(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], bot_guild, state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Music - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="music", notice=notice)
...
def _render_commands(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Commands - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="commands", notice=notice)
...
def _render_logs(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Logs - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="logs", notice=notice)
...
def _render_giveaways(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Giveaways - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="giveaways", notice=notice)
...
def _render_tickets(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Tickets - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="tickets", notice=notice)
...
def _render_welcomer(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"DRAGON HEX Welcomer - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="welcomer", notice=notice)
